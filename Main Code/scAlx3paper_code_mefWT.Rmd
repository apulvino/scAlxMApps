...
nichols_umap.markers4 %>% group_by(cluster) %>% top_n(2, avg_logFC)
...
#FOR SUPPLEMENTAL FIG 1
# Here, we increased the value of min.pct from 0.1 (main fig/supp table) to 0.25 (supp umaps) to generate lists. Many of the same genes we see in previous lists at the 0.1 cutoff appear here. To generate the featureplots we change min.pct below to 0.1
#Doing this will give you results reflected in the manuscript
...
#View(frontonasal.de.markers)
#FNgene_names <- subset(frontonasal.de.markers, frontonasal.de.markers)[,7]
...
png(filename="f_plots.png", height = 500, width = 1000)
featureplots_FN <- FeaturePlot(nichols_umap_clusters_v3, features.plot = FNgene_names[1:15], reduction.use = "umap", cols.use = c("grey","blue"), no.axes = FALSE, no.legend = TRUE, dark.theme = FALSE, do.return = TRUE, max.cutoff = 1.25) + theme(panel.grid = element_rect())+ xlim (c(-10, 10))
dev.off()
png(filename="a_plots.png", height = 500, width = 1000)
featureplots_AR <- FeaturePlot(nichols_umap_clusters_v3, features.plot = ARgene_names[1:15], reduction.use = "umap", cols.use = c("grey","blue"), no.axes = FALSE, no.legend = TRUE, dark.theme = FALSE, do.return = TRUE, max.cutoff = 1.25) + theme(panel.grid = element_rect())+ xlim (c(-10, 10))
dev.off()
png(filename="p_plots.png", height = 500, width = 1000)
featureplots_POST <- FeaturePlot(nichols_umap_clusters_v3, features.plot = POSTgene_names[1:15], reduction.use = "umap", cols.use = c("grey","blue"), no.axes = FALSE, no.legend = TRUE, dark.theme = FALSE, do.return = TRUE, max.cutoff = 1.25) + theme(panel.grid = element_rect())+ xlim (c(-10, 10))  
dev.off()
png(filename="m_plots.png", height = 500, width = 1000)
featureplots_MELANO <- FeaturePlot(nichols_umap_clusters_v3, features.plot = STARgene_names[1:15], reduction.use = "umap", cols.use = c("grey","blue"), no.axes = FALSE, no.legend = TRUE, dark.theme = FALSE, do.return = TRUE, min.cutoff = 0.25, max.cutoff = 1.25)
dev.off()
